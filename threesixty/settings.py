...
DEBUG = bool(os.environ.get("DEBUG", False) in ["1", "true", "True"])
...
WSGI_APPLICATION = "threesixty.wsgi.application"
...
SILENCED_SYSTEM_CHECKS = [
    # HSTS for subdomains should not be set to not affect other services
    "security.W005",
]
